...
function bones_fonts() {
  wp_enqueue_style('googleFonts', 'http://fonts.googleapis.com/css?family=Muli:300,400');
...
function radicalassembly_scripts() {
    ...
    wp_enqueue_script('ra_imp', get_template_directory_uri().'/library/js/demo.js', array('jquery'));
}
