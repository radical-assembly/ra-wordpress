...
function rest_event_form() {
    ...
    <input type="text" id="ev-venue-name" placeholder="Venue name" name="ev-venue-name"><br>
    <input type="text" id="ev-venue-address" placeholder="Venue address" name="ev-venue-address"><br>
    <input type="text" id="ev-venue-city" placeholder="City/Town" name="ev-venue-city"><br>
    <input type="text" id="ev-venue-code" placeholder="Postcode" name="ev-venue-code"><br>
    <input type="text" id="ev-venue-area" placeholder="Venue area/region" name="ev-venue-area"><br>
    Country: <select id="ev-venue-country" name="ev-venue-country"><option value="GB">United Kingdom</option></select><br>
